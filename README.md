...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/fluidsynth-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/fluidsynth-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install fluidsynth
```
...
It is possible to list all of the versions of `fluidsynth` available on your platform:
...
```
pixi search fluidsynth --channel conda-forge
```
